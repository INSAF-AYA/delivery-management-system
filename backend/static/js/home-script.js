document.getElementById('trackBtn').addEventListener('click', function () {
    ...
    if (!trackingNumber) {
        output.innerHTML = '<div class="text-danger">Veuillez entrer un numéro de suivi.</div>';
        return;
    }
    ...
    var shipment = {
        ...
        progress: 60,
        events: [
            { description: 'Shipment created', date: '2025-12-20' },
            { description: 'Picked up by courier', date: '2025-12-21' },
            { description: 'In transit', date: '2025-12-22' }
        ]
    };
