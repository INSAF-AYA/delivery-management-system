...
from database.models import Client, Chauffeur, Package, Shipment, Expedition, Vehicule


class Command(BaseCommand):
    help = 'Seed minimal test data (client, driver, package, shipment, expedition)'
